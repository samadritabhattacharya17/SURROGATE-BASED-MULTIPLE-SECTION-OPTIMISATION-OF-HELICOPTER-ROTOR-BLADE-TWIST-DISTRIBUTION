...
# ============================================================
# RSM-BASED SURROGATE MODEL FOR THRUST COEFFICIENT (CT)
# ============================================================
...
print("==============================================")
print(" RSM-BASED SURROGATE MODEL : CT")
print("==============================================")
...
prediction_database["CT_Predicted"] = y_pred
prediction_database["CT_CV_Predicted"] = y_cv

prediction_database["CT_Error"] = (
    y - y_pred
)

prediction_database["CT_CV_Error"] = (
    y - y_cv
)

prediction_database.to_csv(
    "UH60A_CT_RSM_predictions.csv",
    index=False
)
...
plt.xlabel("Actual $C_T$")
plt.ylabel("Predicted $C_T$")
plt.title("RSM Surrogate: Actual vs Predicted $C_T$")
...
plt.savefig(
    "UH60A_CT_RSM_actual_vs_predicted.png",
    dpi=300
)
...
plt.xlabel("Actual $C_T$")
plt.ylabel("5-Fold CV Predicted $C_T$")
plt.title("5-Fold Cross-Validation: $C_T$")
...
plt.xlabel("Predicted $C_T$")
plt.ylabel("Residual")
plt.title("RSM Residuals: $C_T$")
...
with open(
    "UH60A_CT_RSM_model_info.txt",
    "w"
) as f:

    f.write(
        "UH-60A CT RSM-BASED SURROGATE MODEL\n"
    )
...
print()
print("==============================================")
print(" CT RSM SURROGATE COMPLETE")
print("==============================================")

print("Generated files:")
print("  UH60A_CT_RSM_predictions.csv")
print("  UH60A_CT_RSM_coefficients.csv")
print("  UH60A_CT_RSM_model_info.txt")
print("  UH60A_CT_RSM_actual_vs_predicted.png")
print("  UH60A_CT_RSM_CV.png")
print("  UH60A_CT_RSM_residuals.png")
